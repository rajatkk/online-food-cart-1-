...
{ 
    ...
    public partial class Registration1 : System.Web.UI.Page
    {
        ...
        {
            conn.Open();
            cmd = new SqlCommand("insert into CustomerDetails(Full_Name, Gender, MobileNo,Email,Dob, ADRS,state,city,Pincode) values ('" + TextBox1.Text + "','" + RadioButtonList1.SelectedValue + "', " + TextBox4.Text + ",'" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox11.Text + "','" + DropDownList1.SelectedItem.Text + "','" + DropDownList2.SelectedItem.Text + "'," + TextBox10.Text + ");insert into LoginDetails(Email, Pasword,usertype) values('" + TextBox5.Text + "','" + TextBox13.Text + "','Customer')", conn);
